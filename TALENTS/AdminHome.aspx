                        ...
                        <div class="modal-dialog">
                            <div class="modal-content text-white" style="background-color: #353535;">
                                ...
                                <div class="modal-footer">
                                    <asp:Button runat="server" ID="BtnSaveModel" CssClass="btn btn-lg btn-success" Text="Save" OnClick="BtnSaveModel_Click" />
        ...
        $(function () {
            var datatable = $('#model-table').dataTable({
                ...
                "columns": [{
                    ...
                    "data": null,
                    "render": function (data, type, row, meta) {
                        return '<a href="#" class="btn-delete me-4"><i class="fa fa-trash" style="font-size:25px"></i></a>' + '<a href="AdminModelInformation.aspx?id=' + row.Id + '"><i class="fa fa-edit" style="font-size:25px"></i></a>';
                    }
                }],
