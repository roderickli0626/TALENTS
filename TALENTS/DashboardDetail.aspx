                        ...
                        <div class="container">
                            ...
                            <div class="row p-4 pl-5 pr-5 rounded rounded-5 text-white mx-auto mb-5" style="background-color: #353535; width: 350px">
                                <div class="col-12 pb-2">
                                    ...
                                    <h4 runat="server" id="ModelSurname" class="d-inline float-right">asdf</h4>
                                </div>
                                <div class="col-12 pb-2">
                                    <h4 class="d-inline">Age: </h4>
                                    <h4 runat="server" id="ModelAge" class="d-inline float-right">asdf</h4>
                                </div>
                                <div class="col-12 pb-2">
                                    <h4 class="d-inline">Height: </h4>
                                    <h4 runat="server" id="ModelHeight" class="d-inline float-right">asdf</h4>
                                </div>
                                <div class="col-12 pb-2">
                                    <h4 class="d-inline">Weight: </h4>
                                    <h4 runat="server" id="ModelWeight" class="d-inline float-right">asdf</h4>
                                </div>
                                <div class="col-12 pb-2">
                                    <h4 class="d-inline">Nationality: </h4>
                                    <h4 runat="server" id="ModelEth" class="d-inline float-right">asdf</h4>
                                </div>
                                <div class="col-12">
                                    <h4 class="d-inline">Residence: </h4>
                                    <h4 runat="server" id="ModelResid" class="d-inline float-right">asdf</h4>
                                </div>
                            </div>
                            <div class="row">
