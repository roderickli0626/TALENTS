...
namespace TALENTS
{
    public partial class UserNoticeBoard : System.Web.UI.Page
    {
        ...
        protected void BtnSaveNotice_Click(object sender, EventArgs e)
        {
            ...
            bool success = noticeController.SaveNotice(title, message, contact, sdate, edate, user.Id, null);
        ...
        protected void BtnUpdateNotice_Click(object sender, EventArgs e)
        {
            ...
            bool success = noticeController.SaveNotice(title, message, contact, sdate, edate, user.Id, noticeId);
