<%@ Page Title="" Language="C#" MasterPageFile="~/UserPage.Master" AutoEventWireup="true" CodeBehind="UserNoticeBoard.aspx.cs" Inherits="TALENTS.UserNoticeBoard" %>
    ...
    <script type="text/javascript">
        $(function () {
            var datatable = $('#notice-table').dataTable({
                "serverSide": true,
                "ajax": 'DataService.asmx/FindUserNotices',
            ...
            datatable.on('click', '.btn-delete', function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: 'DataService.asmx/UserDeleteNotice',
                    data: {
                        id: row.Id
                    },
                    success: function () {
